...
export default function FlashcardsPage() {
  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-700 h-[calc(100vh-140px)] flex flex-col">
      <header className="border-b border-gray-100 pb-10 space-y-2 shrink-0 pt-4">
      ...
      {cards.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center text-center space-y-6">
          ...
          <div className="space-y-2">
            <p className="font-playfair text-xl">No Vocabulary Found</p>
        ...
        <div className="flex-1 flex flex-col items-center justify-center w-full max-w-md mx-auto space-y-8">
          <div className="w-full flex justify-between items-center px-2">
            ...
            <p className="nga-label text-[10px] text-green-600">
          ...
          >
            ...
            >
              {/* Front */}
              <div className="absolute w-full h-full backface-hidden bg-white border border-gray-100 rounded-[2rem] shadow-sm flex flex-col items-center justify-center p-8 text-center group-hover:border-gray-300 transition-colors">
                <span className="absolute top-6 left-6 text-[9px] uppercase tracking-widest text-gray-300 font-bold">Front</span>
                <span className="absolute top-6 right-6 text-[9px] uppercase tracking-widest text-indigo-300 font-bold max-w-[120px] truncate">{currentCard.source}</span>
                <h2 className="text-3xl font-playfair leading-relaxed text-gray-900">{currentCard.front}</h2>
              </div>

              {/* Back */}
              <div className="absolute w-full h-full backface-hidden bg-gray-50 border border-gray-200 rounded-[2rem] shadow-sm flex flex-col items-center justify-center p-8 text-center rotate-y-180">
                <span className="absolute top-6 left-6 text-[9px] uppercase tracking-widest text-gray-400 font-bold">Back</span>
                <p className="text-xl font-light text-gray-700 leading-relaxed">{currentCard.back}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6 w-full justify-center">
            <button
              ...
              className="p-4 rounded-full bg-white border border-gray-200 text-gray-400 hover:text-black hover:border-black transition-all"
            >
              <ArrowLeft size={20} />
            </button>
            ...
            <button
              ...
              className={`p-5 rounded-full transition-all border ${
                isMastered 
                  ...
                  : 'bg-white border-gray-200 text-gray-200 hover:text-green-500 hover:border-green-500'
              }`}
            >
            ...
            <button
              ...
              className="p-4 rounded-full bg-black text-white hover:bg-gray-800 transition-all shadow-md shadow-black/10"
            >
              <ArrowRight size={20} />
            </button>
          </div>
